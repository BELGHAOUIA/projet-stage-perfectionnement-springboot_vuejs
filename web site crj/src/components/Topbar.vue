<template>
  ...
  <v-app-bar app elevate-on-scroll elevation="3" style="background-color: white;">
      <img src="../assets/logo.png" alt="" width="150"  class="d-flex d-md-none">
      <v-spacer class="d-flex d-md-none"></v-spacer >
      <v-app-bar-nav-icon  @click="$emit('drawerEvent')" 
      class="d-flex d-md-none"
      ></v-app-bar-nav-icon>

      <img height="60" class="d-none d-md-flex" src="../assets/logo.png" alt="">
      <v-spacer class="d-none d-md-flex"></v-spacer>
      <v-list height="60" class="d-none d-md-flex">
        <v-list-group
      v-for="item in items"
      :key="item.title"
      v-model="item.active"
